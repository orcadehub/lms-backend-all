...
const { getDashboardData, getAdminStats, getInstructorStats, getSystemStats, getInstructorAnalytics, syncCodingProfiles } = require('../controllers/dashboardController');
...
router.post('/sync-coding-profiles', auth, authorize('instructor', 'admin'), syncCodingProfiles);
